...
\section{Honors and Awards}%, and Offers}
...
%
``Generating Synthetic International Institutions for Inference and Model Robustness Testing." (Lorentz Center), 2018.\\[6pt]%April
``How Much Does Fictitious International Law `Matter'?" with Brian Gaines, American Political Science Association (APSA), 2017 \\[6pt]%April
``Foreign Aid Funnel? 
...
Guide development
\begin{quotation}\noindent
``A Step-By-Step Introduction to \LaTeX ", 2015\\[6pt]%%%Jan
``Introduction to Reproducible Research with RStudio", 2015%%%Jan
\end{quotation}
%
