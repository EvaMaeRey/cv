...
\moveright-.1\hoffset\centerline{\normalsize{~%Hoyerswerdaer Stra\ss{}e 23 01099,
% West Point, New York  $\bullet$
\url{evangeline.reynolds@westpoint.edu}} $\bullet$ \href{https://github.com/EvaMaeRey}{github.com/EvaMaeRey} $\bullet$ \href{https://twitter.com/evamaerey}{twitter.com/evamaerey}} % Your name at the top
...
%
% \section{Selected Guide Development}
%
% \begin{quotation}\noindent
