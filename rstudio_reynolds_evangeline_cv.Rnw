...
\documentclass[margin, 10pt]{CVStyleTemplate} % Use the res.cls style, the font size can be changed to 11pt or 12pt here
...
\cfoot{\footnotesize{Page \thepage\ of 4 \\ Evangeline Reynolds CV}}
...
\moveleft2.143\hoffset\centerline{\Large\textsc{Evangeline Reynolds}}% Your name at the top
...
Denver, Colorado  $\bullet$  \url{evangeline.reynolds@du.edu}} $\bullet$ \href{evangelinereynolds.netlify.com}{evangelinereynolds.netlify.com}} % Your name at the top
...
\href{https://evamaerey.github.io/little_flipbooks_library/about/what_the_flipbook}{Flipbooks} are new tools for presenting side-by-side, aligned, incremental code-output evolution via automated code parsing and reconstruction. My R package, \href{https://github.com/EvaMaeRey/flipbookr}{flipbookr} (2019), helps other easily and reliably create their own flipbooks. Examples: \href{https://github.com/EvaMaeRey/ggplot_flipbook}{the ggplot flipbook}
...
R, Stata, SPSS, Git, \LaTeX, Markdown
...
Cofounder \href{https://www.meetup.com/rladies-denver/}{RLadies Denver}, 2019-present \\[6pt]
...
\begin{quotation} \noindent
International Organization and Regimes, 2018, 2017 \\[6pt] %Fall
...
\begin{quotation} \noindent
Research Design, PS 522 (Graduate Level) with James Kuklinski, 2015 \\[6pt] %Fall
